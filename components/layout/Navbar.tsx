...
import { FiHome, FiSearch, FiPlusSquare, FiHeart, FiUser, FiCamera } from 'react-icons/fi';
    ...
    <nav className="fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link href="/home" className="flex items-center gap-2 text-2xl font-bold bg-gradient-to-r from-instagram-pink via-instagram-purple to-instagram-orange bg-clip-text text-transparent">
            <FiCamera className="text-instagram-pink" size={24} />
            <span>Instagram</span>
          </Link>
